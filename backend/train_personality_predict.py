...
if os.path.isfile("personality_label_list"):
    print("Info: personality_label_list found.")
    # =================================================================
    with open("personality_label_list", "r") as labels:
        for line in labels:
            content = line.split()
    ...
    print("Error: personality_label_list file not found.")
